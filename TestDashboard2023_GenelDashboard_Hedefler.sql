...
/****** Object:  StoredProcedure [dbo].[TestDashboard2023_GenelDashboard_Hedefler]    Script Date: 27.02.2023 11:04:04 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Genel Dashboard Bilgileri 2023 hedefi bulunan tüm projeler. [TestDashboard2023_Hedefler] spsinden beslenir.
-- =============================================
CREATE PROCEDURE [dbo].[TestDashboard2023_GenelDashboard_Hedefler]
...
BEGIN
		...
		insert into #tmp_Container (HedefTipi, OCAK, SUBAT, MART, NISAN, MAYIS, HAZIRAN, TEMMUZ, AGUSTOS, EYLUL, EKIM, KASIM, ARALIK, TOPLAMHEDEF, PROJEHEDEFI, PESINFIYATORAN, FLAG)
		EXEC	[dbo].[TestDashboard2023_Hedefler]	@ProjeID
...
select HedefTipi
		...
		,Sum(PROJEHEDEFI) as PROJEHEDEFI
from #tmp_Container
...
BEGIN CATCH
		...
		<body>
			<table cellpadding="0" cellspacing="0" bgcolor="#f3f3f3" width="1400"> 
				<tr>
					<td>TestDashboard2023_GenelDashboard_Hedefler</td>
				</tr>
				<tr>
					<td>'
		...
		EXEC msdb..sp_send_dbmail @profile_name = 'EgeYapi', @recipients = 'onur.gultekin@egeyapi.com', @subject = 'TestDashboard2023_GenelDashboard_Hedefler SPsinde ERROR', @body = @Body, @body_format='HTML'
END CATCH
GO
